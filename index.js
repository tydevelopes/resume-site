...
// To do
// add an element that will show when scrolling begin
// when the element(two kinds) is clicked/tab it should take
// you to the top or bottom of the page depending on scroll
// direction